...
Event.register(window,"load",function() {
	var lightbox = new LightBox({
		loadingimg:'/components/com_rsgallery2/lib/lightbox_plus/loading.gif',
		expandimg:'/components/com_rsgallery2/lib/lightbox_plus/expand.gif',
		shrinkimg:'/components/com_rsgallery2/lib/lightbox_plus/shrink.gif',
		previmg:'/components/com_rsgallery2/lib/lightbox_plus/prev.gif',
		nextimg:'/components/com_rsgallery2/lib/lightbox_plus/next.gif',
// 		effectimg:'/components/com_rsgallery2/lib/lightbox_plus/zzoop.gif',
// 		effectpos:{x:-40,y:-20},
// 		effectclass:'effectable',
		closeimg:'/components/com_rsgallery2/lib/lightbox_plus/close.gif',
		resizable:true
	});
});
